...
- **Curated migration inventory.** The package tracks 156 changelog/model mentions: 105 live `[Obsolete]` metadata rows, 51 supplemental diagnostic rows, and 21 supplemental attribute-value fallback rows outside the 156-count inventory.
